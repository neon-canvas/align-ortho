...
<footer>
	...
	<div class="footer-bottom">
		<div class="row middle-xs">
			...
			<div class="col-xs-12 col-sm-6 affiliates-col">
				<!-- <img src="/wp-content/themes/canvas/img/logo-michigan-university.png" alt="michigan university logo" class="affiliate-logo">
				<img src="/wp-content/themes/canvas/img/logo-mayo-clinic.png" alt="mayo clinic logo logo" class="affiliate-logo">
				<img src="/wp-content/themes/canvas/img/logo-aao.png" alt="aao logo" class="affiliate-logo"> -->

				<img src="/wp-content/uploads/2020/02/Mayo-Clinic-Alumnus-White-Logo.png" alt="mayo clinic logo" class="affiliate-logo" style="max-width: 80px;">
				<img src="/wp-content/uploads/2020/02/DMC-100KB-full.jpg" alt="dmc logo" class="affiliate-logo" style="max-width: 110px;">
				<img src="/wp-content/uploads/2020/02/INV-white.png" alt="invisalign award logo" class="affiliate-logo" style="max-width: 80px;">
				<img src="/wp-content/uploads/2020/03/AAO-logo-reversed.png" alt="aao logo" class="affiliate-logo">
				<img src="/wp-content/uploads/2020/03/MDA-m-reversed.png" alt="mda logo" class="affiliate-logo mda-logo" style="max-width: 150px;">
				<img src="/wp-content/uploads/2020/02/Michigan-Dent-transp-hi-res-reversed.png" alt="university of michigan logo" class="affiliate-logo" style="
				max-width: 150px;">
		</div>
		</div>
	</div>
...
<script type='text/javascript' src='/wp-content/themes/canvas/js/plugins/scrollreveal.min.js'></script>
