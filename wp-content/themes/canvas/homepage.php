...
<main>
	...
	<section class="home-treatments ltgrey-section">
		<div class="container-lrg">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-5 col-sm-offset-1">
					<h2 class="underline-heading fade-element">You've Got Treatment Options</h2>
					<ul class="accordion-menu fade-element">
						<li class="open">
							<div class="dropdownlink invisalign-link">Invisalign
								<div class="plus-icon"><span></span><span></span></div>
							</div>
							<ul class="submenuItems" style="display: block;">
								<li>
									<p>Consider Invisalign® to get the beautiful straight teeth you’ve always wanted—without braces. Dr. Larry Majznerski is in the top 1% of Invisalign providers in the country, so your smile is in the best of hands.</p>
									<p><a href="/invisalign" class="underline-btn">Learn More</a></p>
								</li>
							</ul>
						</li>
						<li>
							<div class="dropdownlink metal-braces-link">Metal Braces
								<div class="plus-icon"><span></span><span></span></div>
							</div>
						...
						<li>
							<div class="dropdownlink ceramic-braces-link">Clear Braces
								<div class="plus-icon"><span></span><span></span></div>
							</div>
							<ul class="submenuItems">
								<li>
						...
						<li>
							<div class="dropdownlink snoring-link">Snoring Treatment
								<div class="plus-icon"><span></span><span></span></div>
							</div>
							<ul class="submenuItems">
								<li>
			...
			<div class="row middle-xs">
				<div class="col-xs-12 col-sm-6 col-md-4 col-one">
					<div class="content-wrapper fade-element">
						...
						<div class="arrow-up"></div>
						<p>“I'm very glad I ran into this office. It was pretty life changing.”</p>
						<div class="underline-btn play-btn" data-video-id="MBNQ26FS9YY"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Watch Video</div>
						<a href="/testimonials" class="underline-btn">View All</a>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-8 col-two">
					<img src="/wp-content/themes/canvas/img/bg-testimonial-headshot-2.png" alt="patient smiling during visit" class="fade-element">
				</div>
			</div>
		</div>
	</section>
	<section class="insta-feed ltgrey-section">
		<div class="container">
