...
<main>
	...
	<section class="our-office dark-section">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-5 col-sm-offset-1">
					...
					<ul class="accordion-menu fade-element">
						<li class="open">
							...
							<ul class="submenuItems" style="display: block;">
								<li>
									...
									<p><a href="#" class="underline-btn">Learn More</a></p>
								</li>
							</ul>
						</li>
						<li>
						...
						<li>
							<div class="dropdownlink ceramic-braces-link">Ceramic Braces
								<div class="plus-icon"><span></span><span></span></div>
							</div>
							<ul class="submenuItems">
								<li>
	...
	<section class="home-testimonials dark-section">
		<div class="container">
			<div class="row middle-xs">
				<div class="col-xs-12 col-sm-6 col-md-4 col-one">
					<div class="content-wrapper fade-element">
	...
	<section class="insta-feed dark-section">
		<div class="container">
